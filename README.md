...
```
deno run --allow-read --allow-run=git --allow-write https://deno.land/x/mod@v1.0.5/mod.ts -n awesome_deno_project
```
...
```
deno install --allow-read --allow-run=git --allow-write -n mod https://deno.land/x/mod@v1.0.5/mod.ts
```
...
installed or `deno run https://deno.land/x/mod@v1.0.5/mod.ts --help`
