...
https://deno.land/x/mod@v2.2.4/mod.ts \
...
```console
deno install --allow-read --allow-run=git --allow-write -n mod https://deno.land/x/mod@v2.2.4/mod.ts
```
...
`deno run https://deno.land/x/mod@v2.2.4/mod.ts --help`
